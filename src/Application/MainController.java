...
public class MainController implements Initializable {
    ...
    protected controllerAgent agent;
    ...
    public void handleAddPropertyBtn(ActionEvent e) throws Exception {
        try {
            ...
            try {
                ObjectInputStream is = xstream.createObjectInputStream(new FileReader("property.xml"));
                property.propertys = (ArrayList<Property>) is.readObject();
                is.close();
            } catch (FileNotFoundException f) {
                property.propertys = new ArrayList<Property>();
                txtFeedBack.setText("New Password File");
            } catch (Exception s) {
            ...
            try {
                ...
                property.propertys.add(propertyLocal);
    ...
    public void handleLoadPropertyBtn(ActionEvent e) throws Exception {
        if(property.propertys.size() == 0) {
            try {
                property.loadProperty();
                txtFeedBack.setText("Properties Loaded");
                txtAreaPropertyInfo.setText(property.listAllLowDetailProperties());
            } catch (Exception t) {
                txtFeedBack.setText("Properties Not Loaded\n" + e);
            }
        }
        else{
            txtAreaPropertyInfo.setText(property.listAllLowDetailProperties());
    ...
    public void changedPropertyType(ActionEvent e) throws Exception {
/*        category = categorySelect.getValue();
        txtAreaPropertyInfo.setText(property.listPropertyType(category));*/
    }

    public void changedLocationGeneral(ActionEvent e) throws Exception {
/*        locationGeneral = locationGeneralSelect.getValue();
        txtAreaPropertyInfo.setText(property.listLocationGeneral(locationGeneral));*/
    }

    public void handleCreatePropertyBtn(ActionEvent e) throws Exception {
        Main.set_pane(7);
    }
    ...
    public void handleAgentReturnHomeBtn(ActionEvent e) throws Exception {
        Main.set_pane(2);
    }


    public void handleRegisterAdminBtn(ActionEvent e) throws Exception {
        Main.set_pane(5);
    }
    ...
    public void handlePaneDeletePropertyBtn(ActionEvent e) throws Exception {
        Main.set_pane(8);
    }
